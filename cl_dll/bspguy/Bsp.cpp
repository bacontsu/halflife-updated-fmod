...
#pragma warning(disable : 4244) // conversion from 'float' to 'int16_t', possible loss of data
#pragma warning(disable : 4267) // conversion from 'size_t' to 'uint16_t', possible loss of data
